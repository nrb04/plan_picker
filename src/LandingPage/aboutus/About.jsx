  ...
  return (
    <div className="max-w-7xl mx-auto  ">
      <div className="relative">
        <div
          className="  max-w-7xl mx-auto p-6 rounded-lg text-center lg:h-[700px] md:h-[600px] h-[500px] flex justify-center items-center flex-col  bg-[#333533] "
          style={{
          ...
          <h1 className="text-4xl  md:text-5xl lg:text-6xl font-semibold text-[#FFEE32] mb-4 z-10">
      ...
      {/*  */}
      <div className="py-[75px] md:py-[150px] flex px-[24px] flex-col md:flex-row gap-4 ">
      ...
      {/*  */}
      <div className="py-[75px] md:py-[150px] bg-[#333533] text-white px-[24px] w-full mb-8 rounded-xl">
        <div className="flex md:flex-row-reverse flex-col gap-8">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="font-semibold mt-8">
              With our exceptional scheduling technology, making plans, booking
              appointments, and coordinating meetings will become as smooth as
              silk. Gone are the days of clunky calendars and double-booked
              dates.
            </p>
          </div>
        </div>
      ...
      {/*  */}
      <div className="py-[75px] md:py-[150px] gap-8 px-[24px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        <div className="bg-gray-200 rounded-xl p-4">
          <div>
            <img className="rounded-2xl" src={EfficientPlanning} alt="" />
          </div>
          <h1 className="font-semibold text-lg my-3">Efficient Planning</h1>
        ...
        <div className="bg-gray-200 rounded-xl p-4">
          <img className="rounded-2xl" src={EfficientPlanning} alt="" />
          <h1 className="font-semibold text-lg my-3">Enhanced Productivity</h1>
          <p className="mb-2">Stay on top of tasks</p>
        </div>
      </div>

      {/*  */}
      <div className="py-[75px] md:py-[150px]  bg-[#333533] text-white px-[24px] mb-8 rounded-xl">
        <div className="flex gap-6 flex-col md:flex-row">
          ...
          />
          <div className="flex flex-col justify-center">
            <h1 className="font-semibold text-3xl">Scheduling Reinvented</h1>
            <p className="font-semibold mt-3">
              ...
              here to save the day! Designed to revolutionize the way you manage
              your time, this app is an essential tool for those on the go.
            </p>
            <p className="font-semibold mt-4">
              Sleek and user-friendly, our scheduler helps you arrange meetings,
              prioritize tasks, and stay on top of your game. Say goodbye to
              double bookings and hello to a stress-free life as you master your
              schedule like a boss.
            </p>
            <p className="font-semibold mt-4">
              Compatible with your favorite calendars, our app syncs
              effortlessly across all your devices, ensuring you’re always up to
              date and in the know. Kiss chaos goodbye and embrace organization
              with open arms—it’s time to level up your scheduling game!
            </p>
          </div>
        </div>
      </div>
      ...
      {/* App Features */}
      <div className="py-[75px] md:py-[150px] px-[24px] bg-[#FDB833] mb-8 rounded-xl">
        <h1 className="mb-8 text-3xl font-semibold">App Features</h1>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-8  ">
          <div className="text-left">
            <h1 className="text-lg">Timezone Sync</h1>
            <p className="pt-2">Automatically adjust to client's timezones.</p>
          </div>

          <div>
            <h1 className="text-lg">Smart Availability</h1>
            <p className="pt-2">Managing your availability like a charm.</p>
          </div>

          <div>
            <h1 className="text-lg">Integrations Galore</h1>
            <p className="pt-2">Sync effortlessly with popular platforms.</p>
          </div>
      ...
      {/* questions */}
      <div className="py-[150px] px-[24px] bg-[#333533] text-white rounded-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:text-left gap-8">
          <div>
            ...
            <p className="pt-2">
              Absolutely! Customize reminders to suit your preferences and never
              miss a beat.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="pt-2">
              Definitely! Our apps integrate seamlessly with popular platforms
              like Google Calendar, Zoom, and more.
            </p>
          </div>
          <div>
            <h1 className="text-lg">How secure is my data?</h1>
            <p className="pt-2">
              We take security seriously. Your data is encrypted and securely
              stored at all times.
            </p>
          </div>
          <div>
            ...
            <p className="pt-2">
              We offer competitive team pricing plans. Head to our pricing page
              for details!
            </p>
          </div>
        </div>
      ...
      {/*  */}
      <div className="py-[200px] px-[24px] bg-gray-100">
